...
let createBlogPath = '/Blog/CreateBlog';
let editBlogPath = '/Blog/EditBlog';
let deleteBlogPath = '/Blog/DeleteBlog';
...
const displayBlogs = () => {
    ...
    if (blogsToShow.length <= 0) {
        ...
        if (blogSearchString == "") {
            divElement.innerHTML =
                `<div class="col-lg-6">
                    <p>Click <a href="${createBlogPath}">here</a> to create your first blog post!</p>
                </div>`;
        } else {
                    ...
                    <div class="card-footer">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-content">
                                <a href="${editBlogPath}/${blogsToShow[i].id}">Edit</a>
                                <a href="${deleteBlogPath}/${blogsToShow[i].id}">Delete</a>
                            </div>
                        </div>
                    </div>
                </div>`;
